...
const Tile = (props) => {
        ...
        <svg width="110" height="110">
          <defs>
            <pattern id="p-tree" x="0" y="0" width=".4" height=".3">
              <rect x="0" y="0" width="42" height="32" fill={brown}/>
        ...
        <svg width="110" height="110">
          <defs>
            <pattern id="p-mtn" x="0" y="0" width=".4" height=".32">
              <rect x="0" y="0" width="42" height="35" fill={gray}/>
        ...
        <svg width="110" height="110">
          <defs>
            <pattern id="p-hill" x="0" y="0" width=".3" height=".1">
              <rect x="0" y="0" width="30" height="10" stroke="white" fill={red}/>
            </pattern>
          </defs>
  ...
  const desert = (
    <React.Fragment>
        <svg width="110" height="110">
          <polygon points="3 26 55 0 107 26 107 77 55 104 3 77" fill={props.type}/>
          <circle cx="55" cy="50" r="15" fill="white" />
          <text x={textX} y="57" fontWeight="bold" fontSize="20px" fill="black">{props.value}</text>
        </svg>
    </React.Fragment>     
