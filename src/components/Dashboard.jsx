    ...
    return (
      <div className="dashboard">
        ...
        <svg className="margin-10" width="120" height="60">
          <rect x="0" y="0" width="120" height="60" fill={green}/>
        ...
        <svg className="margin-10" width="120" height="60">
          ...
          <rect x="20" y="15" width="80" height="30" stroke="white" stroke-width="2" fill={red}/>
        </svg>
        <svg className="margin-10" width="120" height="60">
        ...
        <svg className="margin-10" width="120" height="60">
          <rect x="0" y="0" width="120" height="60" fill={yellow}/>
        ...
        <svg className="margin-10" width="120" height="60">
          <rect x="0" y="0" width="120" height="60" fill={gray}/>
